...
TEXTS = {
    ...
    "lang": "Вас приветствует Центр Наук и Искусств. Благодарим, что позвонили нам.\n\n"
    ...
    "aikido": "Вас приветствует Федерация Айкидо Кыргызской Республики. Благодарим Вас за звонок.\n\n"
